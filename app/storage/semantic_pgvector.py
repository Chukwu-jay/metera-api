...
class PgvectorSemanticStore:
    ...
    async def add(self, record: SemanticRecord) -> None:
        ...
        await pool.execute(
            ...
            VALUES ($1, $2, $3, $4, $5::vector, $6::jsonb, $7, $8, $9::jsonb)
            """,
            record.namespace,
            record.model,
            record.model_family,
    ...
    async def find_best_match(
        ...
        *,
        ...
        created_before_clause = "AND created_at < $7" if created_before is not None else ""
        query = f"""
            SELECT
                namespace,
                model,
            ...
            WHERE namespace = $1
              ...
              AND (model = $4 OR model_family = $2)
              AND (embedding <=> $5::vector) <= $6
              {created_before_clause}
            ORDER BY embedding <=> $5::vector ASC, created_at DESC
            LIMIT 1
            """
        params = [
            namespace,
